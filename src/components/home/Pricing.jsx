  ...
  return (
    <section className="relative py-20">
      ...
      <div className="container">
        ...
        {/* pricings */}
        <div>
          <div className="grid grid-cols-1 gap-y-4 text-white lg:grid-cols-2 lg:gap-x-4 lg:gap-y-0">
              ...
              return (
                <div className="rounded-xl bg-themeDark p-4 lg:p-8" key={i}>
                  ...
                  <div className="mb-6 flex items-center justify-between gap-4">
                    <h4 className="flex justify-start gap-2 font-theme text-4xl font-bold">
                      {title} /{' '}
          ...
          {/* special */}
          <div className="">
            <div className="rounded-xl bg-themeDark p-4 lg:p-8">
              {/* topbar */}
              <div className="mb-6 flex items-center justify-between gap-4">
                <h4 className="flex justify-start gap-2 font-theme text-4xl font-bold">
                  Website In a Day /{' '}
              ...
              <p className="min-h-[70px] opacity-75">
                Imagine having a website that perfectly represents your brand
                and connects with your audience, crafted with precision and
                delivered faster than you thought possible With the Website in a
                Day experience, you’ll get just that without the expensive price
                tag.
              </p>
